...
Download the sample from [here](https://github.com/asgardeo/asgardeo-auth-react-sdk/releases/latest/download/choreo-token-exchange-react-app.zip) and extract the zip file.
